...
var PageRepositoryMongo =
/*#__PURE__*/
function () {
  function PageRepositoryMongo() {
    var _this = this;

    (0, _classCallCheck2["default"])(this, PageRepositoryMongo);
    ...
    client.connect(function (err) {
      ...
      _this.collection = _this.db.collection("pages");
      _this.sequences = _this.db.collection("sequences");
    });
  }

  (0, _createClass2["default"])(PageRepositoryMongo, [{
...
var _default = PageRepositoryMongo;
