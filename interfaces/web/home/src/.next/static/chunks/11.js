...
/***/ "../node_modules/@react-page/plugins-spacer/lib-es/Controls/SpacerDefaultControls.js":
/*!*******************************************************************************************!*\
  !*** ../node_modules/@react-page/plugins-spacer/lib-es/Controls/SpacerDefaultControls.js ***!
  \*******************************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _default_state__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./../default/state */ "../node_modules/@react-page/plugins-spacer/lib-es/default/state.js");
...
var SpacerDefaultControls = function (props) {
    var isPreviewMode = props.isPreviewMode, isEditMode = props.isEditMode, remove = props.remove, Renderer = props.Renderer, changeHeightPreview = props.changeHeightPreview, commitHeight = props.commitHeight, _a = props.state, height = (_a === void 0 ? _default_state__WEBPACK_IMPORTED_MODULE_5__["defaultSpacerState"] : _a).height;
    return (react__WEBPACK_IMPORTED_MODULE_3__["createElement"]("div", { style: { border: 'solid 1px', borderColor: faintBlack }, className: classnames__WEBPACK_IMPORTED_MODULE_2___default()('ory-plugins-content-spacer', {
            'ory-plugins-content-spacer-read-only': isPreviewMode,
        }) }, !isEditMode ? (react__WEBPACK_IMPORTED_MODULE_3__["createElement"](Renderer, __assign({}, props))) : (react__WEBPACK_IMPORTED_MODULE_3__["createElement"](react_resizable__WEBPACK_IMPORTED_MODULE_4__["Resizable"], { onResize: function (e, data) { return changeHeightPreview(data.size.height); }, onResizeStop: function (e, data) { return commitHeight(data.size.height); }, height: height, width: 0 },
        react__WEBPACK_IMPORTED_MODULE_3__["createElement"]("div", { style: { height: height, position: 'relative' } },
            react__WEBPACK_IMPORTED_MODULE_3__["createElement"](_react_page_ui__WEBPACK_IMPORTED_MODULE_1__["BottomToolbar"], __assign({}, props, { icon: props.IconComponent, open: props.focused, title: props.translations.pluginName, onDelete: remove }),
                react__WEBPACK_IMPORTED_MODULE_3__["createElement"](_material_ui_core_TextField__WEBPACK_IMPORTED_MODULE_0__["default"], { placeholder: "24", label: props.translations.elementHeightLabel, style: { width: '512px' }, value: height, onChange: function (e) {
                        return changeHeightPreview(parseInt(e.target.value, 10));
                    }, onBlur: function () { return commitHeight(); }, type: "number" })),
            react__WEBPACK_IMPORTED_MODULE_3__["createElement"]("div", { style: {
                    position: 'absolute',
                    bottom: '0',
                    height: '24px',
                    width: '100%',
                ...
                react__WEBPACK_IMPORTED_MODULE_3__["createElement"]("svg", { viewBox: "0 0 24 24", style: { color: 'white', width: 24, height: 24 } },
                    react__WEBPACK_IMPORTED_MODULE_3__["createElement"]("path", { d: "M20 9H4v2h16V9zM4 15h16v-2H4v2z" }))))))));
};
/* harmony default export */ __webpack_exports__["default"] = (SpacerDefaultControls);
