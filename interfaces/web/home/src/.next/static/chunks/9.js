...
/***/ "../node_modules/@react-page/plugins-image/lib-es/Controls/ImageDefaultControls.js":
/*!*****************************************************************************************!*\
  !*** ../node_modules/@react-page/plugins-image/lib-es/Controls/ImageDefaultControls.js ***!
  \*****************************************************************************************/
/*! exports provided: default */
...
var ImageDefaultControls = function (props) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_5__["createElement"]("div", null,
        react__WEBPACK_IMPORTED_MODULE_5__["createElement"](Renderer, __assign({}, props, { imagePreview: props.imagePreview })),
        !readOnly && focused && (react__WEBPACK_IMPORTED_MODULE_5__["createElement"](_react_page_ui__WEBPACK_IMPORTED_MODULE_4__["BottomToolbar"], __assign({ icon: props.IconComponent, open: props.focused, title: props.translations.pluginName, onDelete: remove }, props),
            react__WEBPACK_IMPORTED_MODULE_5__["createElement"]("div", { style: { display: 'flex' } },
                props.imageUpload && (react__WEBPACK_IMPORTED_MODULE_5__["createElement"](react__WEBPACK_IMPORTED_MODULE_5__["Fragment"], null,
                    react__WEBPACK_IMPORTED_MODULE_5__["createElement"](_react_page_ui__WEBPACK_IMPORTED_MODULE_4__["ImageUpload"], { translations: props.translations, imageUpload: props.imageUpload, imageLoaded: handleImageLoaded, imageUploaded: handleImageUploaded }),
                    react__WEBPACK_IMPORTED_MODULE_5__["createElement"](_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3__["default"], { variant: "body1", style: { marginLeft: '20px', marginRight: '20px' } }, props.translations.or))),
                react__WEBPACK_IMPORTED_MODULE_5__["createElement"](_material_ui_core_TextField__WEBPACK_IMPORTED_MODULE_2__["default"], { placeholder: props.translations.srcPlaceholder, label: props.imageUpload
                        ? props.translations.haveUrl
                        : props.translations.imageUrl, name: "src", 
                    // style={{ flex: 1 }}
                    value: props.state.src, onChange: handleChange })),
            react__WEBPACK_IMPORTED_MODULE_5__["createElement"](_material_ui_core_TextField__WEBPACK_IMPORTED_MODULE_2__["default"], { placeholder: props.translations.hrefPlaceholder, label: props.translations.hrefLabel, name: "href", style: { width: '512px' }, value: props.state.href, onChange: handleChange }),
            react__WEBPACK_IMPORTED_MODULE_5__["createElement"]("br", null),
            react__WEBPACK_IMPORTED_MODULE_5__["createElement"]("br", null),
            react__WEBPACK_IMPORTED_MODULE_5__["createElement"](_material_ui_core_FormControlLabel__WEBPACK_IMPORTED_MODULE_1__["default"], { control: react__WEBPACK_IMPORTED_MODULE_5__["createElement"](_material_ui_core_Checkbox__WEBPACK_IMPORTED_MODULE_0__["default"], { checked: props.state.target === '_blank', name: "target", onChange: handleChange }), label: props.translations.openNewWindow })))));
};
/* harmony default export */ __webpack_exports__["default"] = (ImageDefaultControls);
