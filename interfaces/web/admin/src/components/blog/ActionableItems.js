...
const ActionableItems = ({ title, items }) => (
        ...
        <div key={idx} className="blog-comments__item d-flex p-3">
          ...
          <div className="blog-comments__content">
            ...
            <div className="blog-comments__meta text-mutes">
              <a className="text-secondary" href={item.author.url}>
                {item.author.name}
              </a>{" "}
              on{" "}
              <a className="text-secondary" href={item.post.url}>
                {item.post.title}
              </a>
            ...
            {/* Content :: Body */}
            <p className="m-0 my-1 mb-2 text-muted">{item.body}</p>
